...
document.addEventListener('DOMContentLoaded', function() {
    ...
    submitBtn.addEventListener('click', function() {
        ...
        if (rating && recommend && age) {
            ...
            ganhoValue.textContent = 'R$ 17,52';
            
            // Atualiza o valor no card fixo
            cardRedText.textContent = 'R$ 17,52';
...
document.getElementById("submit-btn").onclick = function() {
    ...
    if (selectedOption) {
        ...
        setTimeout(function() {
            window.location.href = '/tudo junto/3felipeneto/index.html'; // Ajuste o caminho para a página de destino
